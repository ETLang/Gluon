...
namespace ABI
{
    namespace GluonTest
    {
        ABI_CONSTRUCTOR Create_GluonTest_DummyClass_1(DummyClass** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_ConversionUnitTest_1(ConversionUnitTest** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_ITestClass_1(ITestClass** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_SignalBuffer_1(int samples, int channels, int alignment, SignalBuffer** outInstance);
        ABI_CONSTRUCTOR Create_GluonTest_SignalBuffer_2(int samples, SignalBuffer** outInstance);
        ...
        cominterface comid("5a3af0d3-a2ee-3cbb-e6c5-ce3115e18d18") SignalBuffer : public IUnknown
        {
            ...
            METHOD _CopyTo(float* arr, int arr_count, int* ___ret) = 0;
            METHOD _CopyTo(short* arr, int arr_count, int* ___ret) = 0;
        ...
        ABI_CONSTRUCTOR Create_GluonTest_Waveform_1(double* samples, int samples_count, Waveform** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_SinusoidalWaveform_1(SinusoidalWaveform** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_SquareWaveform_1(SquareWaveform** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_TriangleWaveform_1(TriangleWaveform** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_SawtoothRightWaveform_1(SawtoothRightWaveform** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_SawtoothLeftWaveform_1(SawtoothLeftWaveform** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_GTone_1(GTone** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_GWhiteNoise_1(GWhiteNoise** outInstance);
        ...
        ABI_CONSTRUCTOR Create_GluonTest_NoiseEngine_1(NoiseEngine** outInstance);
